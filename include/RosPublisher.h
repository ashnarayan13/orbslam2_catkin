...
#ifndef ROSPUBLISHER_H_
#define ROSPUBLISHER_H_
...
{
  public:
    RosPublisher (ORB_SLAM2::System::eSensor sensor, ros::NodeHandle &node_handle, image_transport::ImageTransport &image_transport);
    ~RosPublisher ();
