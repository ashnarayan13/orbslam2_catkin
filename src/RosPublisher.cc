...
RosPublisher::RosPublisher (ORB_SLAM2::System::eSensor sensor, ros::NodeHandle &node_handle, image_transport::ImageTransport &image_transport) {
...
void RosPublisher::PublishMapPoints (std::vector<ORB_SLAM2::MapPoint*> map_points) {
  sensor_msgs::PointCloud2 cloud = MapPointsToPointCloud (map_points);
  map_points_publisher_.publish (cloud);
}


void RosPublisher::PublishPositionAsTransform (cv::Mat position) {
...
void RosPublisher::PublishPositionAsPoseStamped (cv::Mat position) {
...
void RosPublisher::PublishRenderedImage (cv::Mat image) {
...
tf::Transform RosPublisher::TransformFromMat (cv::Mat position_mat) {
...
sensor_msgs::PointCloud2 RosPublisher::MapPointsToPointCloud (std::vector<ORB_SLAM2::MapPoint*> map_points) {
